...
def monopoly_with_second_tier
  ...
  hash[:railroads][:rent_in_dollars] = Hash.new
  hash[:railroads][:names] = Hash.new
  hash
end
def monopoly_with_third_tier
  ...
  hash[:railroads][:names][:reading_railroad] = Hash.new
  hash[:railroads][:names][:pennsylvania_railroad] = Hash.new
  hash[:railroads][:names][:b_and_o_railroad] = Hash.new
  hash[:railroads][:names][:shortline_railroad] = Hash.new
